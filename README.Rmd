...
The repository also ships a small `Rscript` utility that downloads Yahoo Finance
OHLC data and runs the package engine end to end:
...
Use repeated `--metric-arg` flags for metric-specific overrides, for example:
